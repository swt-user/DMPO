...
python -m torch.distributed.run --nproc_per_node=${gpu_num} --master_port=20001 fastchat/train/train_mistral.py \
...
python -m torch.distributed.run --nproc_per_node=${gpu_num} --master_port=20001 fastchat/train/train_dmpo_efficient_mistral.py \
