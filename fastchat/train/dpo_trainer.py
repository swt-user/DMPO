...
# TODO:DPO LOSS
    ...
    def get_batch_logps(
        ...
        #print(f'@%@logits_-1: {logits.shape[:-1]}')
    ...
    def concatenated_forward(
        ...
        #print(f'%%%concatenated_batch: {concatenated_batch}')
        ###print("********************************^^^^^^^^^^^^^^^^^^^^^^^^^^^^^concatenated_forward&&&&&concatenated_batch***************")
        ##print(concatenated_batch)
        len_chosen = batch["chosen_labels"].shape[0]
        #print(f'!@#$len_chosen: {len_chosen}')
        #print(f'!@#$batch: {batch["chosen_labels"]}')
        ...
        #print("********************************^^^^^^^^^^^^^^^^^^^^^^^^^^^^^concatenated_forward&&&&&chosen_logps")
        #print(f'123^^^^^^^^concatenated_forward&&&&&chosen_logps:{chosen_logps}')
        #print("********************************^^^^^^^^^^^^^^^^^^^^^^^^^^^^^concatenated_forward&&&&&rejected_logps")
        #print(f'123^^^^^^^^concatenated_forward&&&&&rejected_logps:{rejected_logps}')
        '''print("********************************^^^^^^^^^^^^^^^^^^^^^^^^^^^^^concatenated_forward&&&&&chosen_logits")
        print(chosen_logits)
        print("********************************^^^^^^^^^^^^^^^^^^^^^^^^^^^^^concatenated_forward&&&&&rejected_logits")
        print(rejected_logits)'''
    ...
    def get_batch_loss_metrics(
        ...
        ###print("^^^^^^^^^^^^^^^^^^^^^^^^^^^^***************************************get_batch_loss_metrics&&losses")
        ##print(losses)
        ###print("^^^^^^^^^^^^^^^^^^^^^^^^^^^^***************************************get_batch_loss_metrics&&metrics")
        ##print(metrics)
        #print(batch[0])
