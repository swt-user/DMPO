...
def create_model_worker():
    ...
    if args.gpus:
        ...
        if args.num_gpus == 1:
            list_gpu = args.gpus.split(",")
            print(f'environment: {os.environ["CUDA_VISIBLE_DEVICES"]}')
            os.environ["CUDA_VISIBLE_DEVICES"] = list_gpu[args.gpu_index]
            print(f"launch the {list_gpu} process in GPU:{list_gpu[args.gpu_index]}!!!!!")
            print(f'environment: {os.environ["CUDA_VISIBLE_DEVICES"]}')
        else:
            os.environ["CUDA_VISIBLE_DEVICES"] = args.gpus
